...
public class Dao {
	...
	protected static String dbUrl = "jdbc:mysql:///db_library?useSSL=false&serverTimezone=UTC&useUnicode=true&characterEncoding=UTF-8";
	protected static String dbUser = "root";
	protected static String dbPwd = "999520";
...
//	}
	 ...
	 * 插入图书信息方法
	 */
	public static int Insertbook(String ISBN,String typeId,String bookname,String writer,String translator,String publisher,String date,Double price){
		int i=0;
		try{
	...
	public static List selectBookInfo() {
		...
		try {
			while (rs.next()) {
				...
				bookinfo.setDate(rs.getString("date"));
...
//	}
	 ...
	 * 对读者信息表执行的相关操作
	 */
	public static int InsertReader(String name,String sex,String age,String identityCard,String date,String maxNum,String tel,Double keepMoney,String zj,String zy,String bztime,String ISBN){
		int i=0;
	...
	public static List selectReader() {
		...
		try {
			while (rs.next()) {
				...
				reader.setDate(rs.getString("date"));
...
//				reader.setBztime(rs.getDate("bztime"));
	...
	public static int UpdateReader(String id,String name,String sex,String age,String identityCard,String date,String maxNum,String tel,Double keepMoney,String zj,String zy,String bztime,String ISBN){
		int i=0;
		try{
 ...
 */
	 ...
	 * 对借阅表进行操作
	 */
	public static int InsertBookBorrow(String bookISBN,String readerISBN,String num,String  borrowDate,String  backDate,String bookNames){
		int i=0;
		try{
			String sql="insert into tb_borrow(bookISBN,readerISBN,num,borrowDate,backDate,bookName)values('"+bookISBN+"','"+readerISBN+"','"+num+"','"+borrowDate+"','"+backDate+"','"+bookNames+"')";
			i=Dao.executeUpdate(sql);
		}catch(Exception e){
			e.printStackTrace();
		}
	...
	public static List selectBorrow(String readerISBN) {
		...
		try {
			while (rs.next()) {
				...
				borrow.setBorrowDate(rs.getString("num"));
	...
	public static List selectbookserch() {
		...
		try {
			while (s.next()) {
				...
				bookinfo.setDate(s.getString(7));
	...
	public static int Insertoperator(String name,String sex,int age,String identityCard,String workdate,String tel,String password){
		int i=0;
		try{
			String sql="insert into tb_addoper(name,sex,age,identityCard,workdate,tel,password) values('"+name+"','"+sex+"',"+age+",'"+identityCard+"','"+workdate+"','"+tel+"','"+password+"')";
			System.out.println(sql);
			i=Dao.executeUpdate(sql);
		}catch(Exception e){
			e.printStackTrace();
	...
	public static List selectuser() {
		List list=new ArrayList();
		String sql = "select id,name,sex,age,identityCard,workdate,tel,password  from tb_addoper where admin=0";
		ResultSet rs = Dao.executeQuery(sql);
		try {
			while (rs.next()) {
				user user=new user();
				...
				user.setWorkdate(rs.getString(6));
	...
	public static int Deluser(int id){
		int i=0;
		try{
			String sql="delete from tb_addoper where id='"+id+"'";
			//System.out.println(sql);
			i=Dao.executeUpdate(sql);
		}catch(Exception e){
			e.printStackTrace();
	...
	public static int Updateuser(int id,String name,String sex,int age,String identityCard,String workdate,String tel,String password){
		int i=0;
		try{
			String sql="update tb_addoper set name='"+name+"',sex='"+sex+"',age="+age+",identityCard='"+identityCard+"',workdate='"+workdate+"',tel='"+tel+"',password='"+password+"' where id='"+id+"'";
			i=Dao.executeUpdate(sql);
		}catch(Exception e){
			e.printStackTrace();
		}
