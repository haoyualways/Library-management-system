...
/*			if(readername.getText().length()==0){
		...
		*/
		    ...
		    int i=Dao.InsertReader(readername.getText().trim(), sex.trim(), age.getText().trim(),zjnumber.getText().trim(),date.getText().trim(), maxnumber.getText().trim(),tel.getText().trim(), Double.valueOf(keepmoney.getText().trim()),zj,zy.getText().trim(),bztime.getText().trim(),ISBN.getText().trim());
